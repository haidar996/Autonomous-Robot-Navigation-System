...
class vertix:
    def __init__(self,x,y,asci):
        ...
        self.asci=asci
class A_star:
    def __init__(self,vertices_number,node_symbols,graph,graph1):
    ...
    def run_A_star(self,start_node):
        ...
        for i in range(self.V):
            ...
            for u in range(self.V):
                ...
                if self.graph[u][node]>0 and visited[u]==False and dist[u]>=dist[node]+self.graph[node][u]+self.graph1[0][u] :

                    if jumps[node]+1>jumps[u] and dist[u]==dist[node]+self.graph[node][u]+self.graph1[0][u]:
                        pass
                    ...
                    dist[u]=dist[node]+self.graph[node][u]+self.graph1[0][u]
